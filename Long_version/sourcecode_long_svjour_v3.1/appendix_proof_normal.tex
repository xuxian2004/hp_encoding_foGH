...
We show that \R is a normal bisimulation (\xxx{up-to restriction and $\WNB$}? seem need to expand.). We make a case analysis. % about the context $C$.
...
\sepp
{\tiny \xx{\tiny seems not quite work out due to failure of bisimulation up-to weak bisimilarity ...}
