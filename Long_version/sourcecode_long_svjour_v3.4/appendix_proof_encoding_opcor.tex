...
\end{array}
\] \xxx{Notice that the first $\WCB$ follows from a communication over the restricted name $m$.} 
\end{itemize}
...
\end{array}
\]
\xxx{Notice that the first $\WCB$ results from a communication over the restricted name $m$.}
\end{itemize}
\end{itemize}
\myqed
\end{proof}
