...
As explained in Section \ref{s:introduction}, the factorization theorem is the cornerstone of characterizing context \xxx{bisimilarity} with normal \xxx{bisimilarity}, and 
...
\xxx{The proof is similar to the congruence proofs in \cite{San92,SW01a,Xu13,DHS18}. 
...
\xxx{To be complete, we give the proof of Theorem \ref{thm:normal_congru} in Appendix \ref{s:normal}.
}
\xxx{We also note that in much the same way as Definition \ref{d:up2} and Theorem \ref{thm:sound_up-to_context_general}, we can define normal bisimulation up-to (context) and show its validity. }
