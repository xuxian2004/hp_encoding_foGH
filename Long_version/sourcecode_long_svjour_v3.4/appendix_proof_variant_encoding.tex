...
We below prove Lemma \ref{l:opcor_var}, and Lemma \ref{l:opcor-conv_var} can be similarly proven. We note that these lemmas can be lifted to the weak case, as for the encoding in Section \ref{ss:encoding_def}.
\xxx{
...
\xxx{In spite of the failure of the soundness in either general or weak cases, fortuitously the encoding indeed has completeness.
} 
