...
%}
%\]
\xx{The encoding strategy above only employs parameterization on name. One might wonder why not use \HOPiDd\ with process parameterization eliminated. We will comment on this at the end of this section. 
...
\xx{Below first give an example of the encoding by reusing the instances in the last section, and then move on with the discussion of the encoding.
}
