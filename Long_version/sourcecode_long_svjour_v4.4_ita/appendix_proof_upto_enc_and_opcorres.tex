\section{\xxxx{Proofs for Section \ref{s:encoding}}}\label{appendix:up-to-context_encodings_and_opcorres}



\subsection{Proof for the operational correspondence of the encoding in Section \ref{s:encoding}}\label{appendix:opcorres_encoding}
We here give the proof of Lemma \ref{l:opcor}.
...
\subsection{Proof of up-to context technique in Section \ref{s:encoding}}\label{appendix:up-to-context_encodings}
...
%\]
\[
\R' \DEF \{(C[P], C[Q]) \,|\, P \,\R\, Q, \mbox{ and $C$ is a context as by Definition \ref{d:up3_encoding}}\} %tttttttt
\]
