...
\noindent\textit{Remark}. For the sake of conciseness, in the arguments in the appendix, we sometimes omit the existential statement such as ``for some ..." if clear from context.
