...
%\usepackage{hyperref} % ×îºÃ±£Ö¤ hyperref ÊÇ×îºó¼ÓÔØµÄºê°ü
%\hypersetup{%
%  dvipdfmx,% Éè¶¨ÒªÊ¹ÓÃµÄ driver Îª dvipdfmx
%  unicode={true},% Ê¹ÓÃ unicode À´±àÂë PDF ×Ö·û´®
%  pdfstartview={FitH},% ÎÄµµ³õÊ¼ÊÓÍ¼ÎªÆ¥Åä¿í¶È
%  bookmarksnumbered={true},% ÊéÇ©¸½ÉÏÕÂ½Ú±àºÅ
...
%  pdfkeywords={¹Ø¼ü´Ê},
%  pdfcreator={Ó¦ÓÃ³ÌÐò},
%  pdfproducer={PDF ÖÆ×÷³ÌÐò},% Õâ¸öºÃÏñÃ»Æð×÷ÓÃ£¿
%}
%---------------------------packages end----------------------------------------------------------------
...
\newcommand{\SSEQV}{\ensuremath{\equiv} }%strong structural congruence for general HO: may be \equiv or \sim
%
...
\newcommand{\xxrmcolor}[1]{#1} %for removing the color
\newcommand{\xxz}[1]{{\textcolor[RGB]{205,185,0}{#1}}}
\newcommand{\xxy}[1]{{\textcolor[RGB]{0,205,175}{#1}}}
%\newcommand{\xxxx}[1]{{\textcolor[RGB]{0,185,205}{#1}}}
\newcommand{\xxxx}[1]{#1}
\newcommand{\xiv}[1]{{\textcolor[RGB]{185,0,205}{#1}}}
%\newcommand{\xiv}[1]{#1}
%\newcommand{\xxx}[1]{{\textcolor[RGB]{205,185,0}{#1}}}
\newcommand{\xxx}[1]{#1}

\newcommand{\xxxrmcolor}[1]{#1 } %for removing the color

\newcommand{\oo}[1]{{\color{red} #1}}
\newcommand{\nts}[1]{{\textcolor[RGB]{0,221,0}{#1}}}
\newcommand{\ntsrm}[1]{} %for removing the notes after usage
\newcommand{\ntsoo}[1]{{\textcolor[RGB]{204,153,255}{#1}}}
\newcommand{\ntsoorm}[1]{} %for removing the notes after usage
